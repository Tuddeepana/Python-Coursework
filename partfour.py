...
def call(flag):
    ...
    while True:
        ...
        if total != 120:
            ...
            elif (pass_c == 40 and defer_c == 0) and (pass_c == 20 and defer_c == 0) and (pass_c == 20 and defer_c == 0) and (
    ...
    if flag:
        print()
        progress_data[index] = [pass_c, defer_c, fail_c]
...
for index in progress_data:
    progress = progress_data[index]
    pass_c = progress[0]
    defer_c = progress[1]
    fail_c = progress[2]
